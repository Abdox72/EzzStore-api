        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerAddress = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    CustomerCity = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    CustomerPostalCode = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "أجود أنواع العود من أفضل المصادر العالمية", "/uploads/categories/عود.webp", "العود" },
                    { 2, "مسك طبيعي من أفضل المناطق", "/uploads/categories/مسك.png", "المسك" },
                    { 3, "مجموعة فاخرة من العطور العالمية", "/uploads/categories/عطور.jpg", "العطور" },
                    { 4, "بخور عالي الجودة بروائح مميزة", "/uploads/categories/بخور.webp", "البخور" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "عود هندي فاخر برائحة غنية", 100.00m, 100, "عود هندي" },
                    { 2, 2, "مسك أبيض نقي برائحة مميزة", 50.00m, 200, "مسك أبيض" },
                    { 3, 3, "عطر فرنسي فخم برائحة جذابة", 200.00m, 50, "عطر فرنسي" },
                    { 4, 4, "بخور عربي تقليدي بروائح عطرة", 30.00m, 20, "بخور عربي" },
                    { 5, 4, "بخور تركي أصلي بروائح مدهشه", 45.00m, 39, "بخور تركي" },
                    { 6, 3, "عطر برازيلي فخم برائحة منعشه", 250.00m, 303, "عطر برازيلي" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "/uploads/products/عود.webp", 1 },
                    { 2, "/uploads/products/مسك.png", 2 },
                    { 3, "/uploads/products/عطور.jpg", 3 },
                    { 4, "/uploads/products/بخور.webp", 4 },
                    { 5, "/uploads/products/بخور.webp", 5 },
                    { 6, "/uploads/products/عطور.jpg", 6 }
                });
